...
/*   Updated: 2024/02/04 13:05:48 by doriani          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_cl_list *
cl_dup_node(t_cl_list *node, void *(*dup_data)(void *) ) {
...
t_cl_list *
cl_dup_node_by_position(t_cl_list *head, int position,
                        void *(*dup_data)(void *) ) {
...
t_cl_list *
cl_dup_list(t_cl_list *head, void *(*dup_data)(void *) ) {
    t_cl_list *new;
...
void
cl_foreach(t_cl_list *head, void (*f)(void *)) {
    t_cl_list *temp;
...
t_cl_list *
cl_map(t_cl_list *head, void (*f)(void *), void *(*dup_data)(void *) ) {
