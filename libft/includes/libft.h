...
typedef enum e_direction { straight, reverse } t_direction;
typedef enum e_sort_order { ascending, descending } t_sort_order;
...
void sl_display(t_sl_list *head, void (*display)(void *));
// defined in sl_insertions.c
...
// defined in sl_additions.c
void sl_add_node_begin(t_sl_list *head, t_sl_list *new_node);
void sl_add_node_end(t_sl_list *head, t_sl_list *new_node);
void sl_add_node_by_position(t_sl_list *head, t_sl_list *new_node,
                             int position);
// defined in sl_removals.c
...
t_sl_list *sl_get_node_by_data(t_sl_list *head, void *data,
                               int (*cmp_data)(void *, void *));
// defined in sl_data_management1.c
...
void sl_set_node_data_by_position(t_sl_list *head, void *data, int position);
// defined in sl_data_management2.c
...
void sl_sort(t_sl_list **head, t_sort_order order,
             int (*cmp_data)(void *, void *));
// defined in sl_utils2.c
void sl_swap_list_nodes(t_sl_list *a, t_sl_list *b, t_sl_list **head_a,
                        t_sl_list **head_b);
void sl_swap_list_nodes_by_position(t_sl_list **head, int a, int b);
t_sl_list *sl_get_node_by_position(t_sl_list *head, int position);
t_sl_list *sl_get_node_by_data(t_sl_list *head, void *data,
                               int (*cmp_data)(void *, void *));
int sl_is_sorted(t_sl_list *head, t_sort_order order,
                 int (*cmp_data)(void *, void *));
// defined in sl_utils3.c
...
t_sl_list *sl_map(t_sl_list *head, void (*f)(void *),
                  void *(*dup_data)(void *) );
/* CIRCULAR LISTS MANAGEMENT FUNCTION PROTOTYPES */
...
t_cl_list *cl_remove_begin(t_cl_list *head);
t_cl_list *cl_remove_end(t_cl_list *head);
...
void cl_set_node_data_by_position(t_cl_list *head, void *data, int position);
